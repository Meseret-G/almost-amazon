...
const viewBook = (obj) => {
  ...
  document.querySelector('#view').innerHTML += `
    <div class="mt-5 d-flex flex-wrap">
     ...
     <hr>
       <p>${obj.description || 'Please add a description for the book.'}</p>
       <hr>
       <p> PRICE: ${obj.sale ? `<span class="badge bg-info sale-badge"><i class="fa fa-bell" aria-hidden="true"></i> Sale</span> 
